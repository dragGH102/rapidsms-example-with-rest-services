# > This is the MAIN project directory (default displayed app) with the settings that apply to all the other apps in the project
...
SECRET_KEY = '_cx9leog^ngu&a$8med&lsy@230j$5t@9ja++qbrdr9y!10u&*'
...
INSTALLED_APPS = (
    ...
    "rest_framework",
    # RapidSMS
    "tut", # app developed by me following tutorial (part 1-2)
    "voting", # app developed by me following tutorial (part 3+)
    "rapidsms",
    ...
    "rapidsms.contrib.handlers", # this + other radpisms.contrib listed below ==> apps accessible from  http://localhost:8000/ when running rapidsms_tut app (DEFAULT application: rapidsms.contrib.default) within rapidsms_tut project in rapidsms_tut-venv (virtualenv to isolate apps execution environment)
    "rapidsms.contrib.default",  # Must be last (in order to not calling it until the other apps have been considered for HANDLING the message)
)
...
RAPIDSMS_HANDLERS = (
    "tut.handlers.HelpHandler", # NOTE: we put "app name" BEFORE the name of the actual file
    # "myhandlers.SumHandler",
    "tut.handlers.CalcHandler",
